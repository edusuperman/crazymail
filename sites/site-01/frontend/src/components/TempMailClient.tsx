        ...
        <section className="flex-1 w-full max-w-2xl mx-auto px-4 pb-16">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              disabled={refreshing}
              className="flex items-center gap-2 rounded-lg bg-slate-700 hover:bg-slate-600 px-3 py-2 text-sm font-medium transition disabled:opacity-60 disabled:cursor-not-allowed"
            >
              <svg
                ...
                >
                  <div className="flex items-center">
                    ...
                    <button
                      ...
                      className="shrink-0 p-2 mr-2 rounded-lg text-slate-500 hover:text-red-400 hover:bg-slate-700 transition"
                      title="Delete email"
                    >
                      <svg
                        className="w-4 h-4"
