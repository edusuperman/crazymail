  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="prose prose-gray prose-lg max-w-none">
        ...
        <p>Let me break down the numbers, because they're wild:</p>
        ...
        <ul>
          ...
          <li>Data compiled from <strong>dozens of older breaches</strong> — not new hacks, but aggregated old ones</li>
        ...
        <p>
          Think about how many services you've signed up for. Social media, shopping sites,
          newsletters, free trials, forums — the list goes on.
        </p>

        <p>
          Now think about this: <strong>every single one of those services is a potential breach
          point.</strong> When any of them gets hacked, your email address — and potentially your
          password — gets added to a database that criminals can access.
        </p>

        <p>Here's what happens after your email is leaked:</p>

        <ol>
          <li><strong>Phishing attacks</strong> — Scammers send emails that look like they're from services you actually use</li>
          <li><strong>Credential stuffing</strong> — They try your leaked password on hundreds of other sites</li>
        ...
        <p>
          I've seen it happen to friends. One guy used the same email and password for everything.
          After a small forum he'd forgotten about got breached, he lost access to his Google account,
          his banking app, and his Spotify — all in the same week.
        </p>
        ...
        <div className="my-6 space-y-4">
          <div className="rounded-lg border border-border p-4">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Banking, government, important accounts. Never shared publicly.
            </p>
          </div>
          <div className="rounded-lg border border-border p-4">
            <p className="font-semibold">📧 Secondary email</p>
            <p className="mt-1 text-sm text-muted-foreground">
              Social media, shopping, subscriptions. Used for services I actually care about.
            </p>
          </div>
          <div className="rounded-lg border border-primary/50 bg-primary/5 p-4">
            <p className="font-semibold">🗑️ Temporary email</p>
            <p className="mt-1 text-sm text-muted-foreground">
              Free trials, one-time signups, newsletters, forums, anything I don't trust. This is where
              services like <Link to="/" className="text-primary underline">TempMails.top</Link> come in.
            </p>
          </div>
        </div>

        <p>
          When a temporary email gets leaked (and it will), who cares? It's already expired.
          The address doesn't exist anymore. The breach database has a dead email that leads nowhere.
        </p>
        ...
        <ol>
          <li>
            <strong>Check if your email has been leaked.</strong> Go to{" "}
            <a href="https://haveibeenpwned.com" target="_blank" rel="noopener noreferrer" className="text-primary underline">
              Have I Been Pwned
            </a>{" "}
            and enter your email. You might be surprised.
          </li>
          <li>
            <strong>Start using temporary email for low-stakes signups.</strong>{" "}
            <Link to="/" className="text-primary underline">TempMails.top</Link> gives you a
            working address in seconds — no registration, no tracking.
          </li>
          <li>
            <strong>Enable 2FA on your important accounts.</strong> If your email does get leaked,
            two-factor authentication is your last line of defense.
          </li>
        </ol>
        ...
        <p>
          Yes. Using temporary email is completely legal in most countries. It's a privacy tool,
          not a tool for fraud or abuse. Think of it like using a P.O. box instead of your home address.
        </p>
